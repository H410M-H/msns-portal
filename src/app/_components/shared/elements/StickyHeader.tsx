    ...
    >
      <div className="container mx-auto px-4 h-full flex items-center justify-between">
        ...
        className="flex items-center">
            <Image
              src="/avif/off_logo_medium.avif" // Add the image path in the public folder
              alt="Logo"
              width={50}
              height={50}
        ...
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            ...
            >
              <CircleUserRound className="size-10 text-emerald-800 hover:bg-white/20 focus:ring-2 focus:ring-offset-2 rounded-full" />
            </Button>
          </DropdownMenuTrigger>
          <DropdownMenuContent
            align="end"
